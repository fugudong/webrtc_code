...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public VideoEncoder createEncoder(VideoCodecInfo input) {
        ...
        if (info == null) {
            Log.e("darren_test", "info ==null");
            return null;
        }

        String codecName = info.getName();
        String mime = type.mimeType();
        Log.e("darren_test", "createEncoder codecName：" + codecName + ",mimeType" + mime);
        ...
        if (type == VideoCodecType.H264) {
            ...
            if (!isHighProfile && !isBaselineProfile) {
                Log.e("darren_test", "createEncoder 不支持1");
                return null;
            }
            if (isHighProfile && !isH264HighProfileSupported(info)) {
                Log.e("darren_test", "createEncoder 不支持2  ");
                return null;
            }
        }
